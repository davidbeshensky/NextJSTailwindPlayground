  ...
  return (
    <div className="flex justify-center items-center h-screen bg-orange-800">
      <div className="flex flex-row">
        ...
        />
        <motion.div
          className="w-32 h-32 rounded-20 border rounded-lg rotate-45"
          animate={{ x, y, rotate }}
          transition={{ type: "spring" }}
        />
        <motion.div
      ...
      <div className="absolute top-0 left-1/2 mt-6">
        <button
          ...
          className="border border-white px-2 py-1 m-1 hover:bg-orange-500 shadow-2xl transition duration-300 ease-in-out transform hover:scale-105 hover:opacity-75"
        >
          x
        </button>
        <button
        ...
        <button
          onClick={handleChaos}
          className="border border-whiter px-2 py-1 m-1 hover:bg-orange-500 shadow-2xl transition duration-300 ease-in-out transform hover:scale-105 hover:opacity-75"
        >
